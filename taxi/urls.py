...
from .views import index, CarListView, CarDetailView, DriverListView, DriverDetailView, ManufacturerListView, \
    CarCreateView, CarUpdateView, CarUpdateView, CarDeleteView, ManufacturerCreateView, ManufacturerUpdateView, \
    ManufacturerDeleteView, DriverCreateView, DriverLicenseUpdateView, DriverDeleteView, manipulation_with_car
